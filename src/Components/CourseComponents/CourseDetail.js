...
function CourseDetail (props) {
    ...
    const deleteCourse = async () => {
        try {
            await axios.delete(`https://portfolio-acm-client.netlify.app/api/courses/${id}`, {
                auth: {
    ...
    useEffect(() => {
        const fetchCourse = async () => {
            try {     
                const response = await axios.get(`https://portfolio-acm-client.netlify.app/api/courses/${id}`)
